...
function(input, output, session) {
  ...
  observeEvent(input$show_report, {
    ...
    print(data_to_report()$Trans)
    print(dat_slope()$coefficients[2])
    print(data_to_report()$Q)
    print(data_to_report()$well_stor)
    
    print(data_to_report()$Cbar)
